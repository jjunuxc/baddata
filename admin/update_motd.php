    ...
    <body>
        ...
        <div id="content">
            <form class="center_form" action="update_motd.php" method="POST">
                <h1>Update Message of the Day:</h1>
                Set a message of the day for the users when they log in.<br><br>
            ...
            <form class="center_form" action="upload_image.php" method="POST" enctype="multipart/form-data">
                <h1>Upload Images:</h1>
                These images will be displayed under the message of the day. <br><br>
